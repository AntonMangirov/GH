    ...
    <Box sx={{ mt: 4, mb: 4 }}>
      ...
      <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3, mb: 3 }}>
        <Paper sx={{ p: 2, flex: "1 1 400px", minWidth: 400, height: 300 }}>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <LineChart
              data={[
                {
                  month: "1м",
                  current: result.monthlySavings,
                  potential: result.monthlySavings * 1.3,
                },
                {
                  month: "2м",
                  current: result.monthlySavings * 2,
                  potential: result.monthlySavings * 1.3 * 2,
                },
                {
                  month: "3м",
                  current: result.monthlySavings * 3,
                  potential: result.monthlySavings * 1.3 * 3,
                },
                {
                  month: "4м",
                  current: result.monthlySavings * 4,
                  potential: result.monthlySavings * 1.3 * 4,
                },
                {
                  month: "5м",
                  current: result.monthlySavings * 5,
                  potential: result.monthlySavings * 1.3 * 5,
                },
                {
                  month: "6м",
                  current: result.monthlySavings * 6,
                  potential: result.monthlySavings * 1.3 * 6,
                },
              ]}
            >
          ...
          >
            Фиолетовая линия - текущие накопления, зеленая - с экономией
            расходов
          </Typography>
        </Paper>
        ...
        <CardContent>
          ...
          {result.estimatedTimeToGoal > 0 && (
            <Typography variant="body2" color="text.secondary">
              Оценка времени достижения цели: {result.estimatedTimeToGoal}{" "}
              месяцев
            </Typography>
          )}
        </CardContent>
