...
const Results = () => {
  const { analysisResult, showResult } = useFormContext();
      ...
      <Box sx={{ mb: 4, textAlign: "center" }}>
        ...
        {analysisResult.isLocalAnalysis && (
          <Alert severity="info" sx={{ mt: 2, mb: 2 }}>
            ...
            Мы создали для вас рекомендации самостоятельно на основе ваших
            данных.
          </Alert>
        )}
      </Box>

      <AnalysisResult result={analysisResult} isVisible={true} />
